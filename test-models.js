...
const { getSettingsManager } = require('./dist/utils/settings-manager.js');
const { loadModelConfig } = require('./dist/utils/model-config.js');
...
const settingsPath = path.join(require('os').homedir(), '.grok', 'user-settings.json');
